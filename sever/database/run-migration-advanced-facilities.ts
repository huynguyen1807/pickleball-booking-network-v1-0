...
async function runMigration() {
    console.log('🚀 Running advanced facility migration...\n');

    try {
        const pool = await poolPromise;

        const migratePath = path.join(__dirname, '02-advanced-facility-migration.sql');
        ...
        console.log(`\n🎉 Advanced Facility Migration completed successfully!`);
