...
const io = new Server(server, {
    cors: { origin: [frontendOrigin, 'http://localhost:5173', 'http://localhost:3000'], methods: ['GET', 'POST'] }
});

// Middleware
app.use(cors({ origin: [frontendOrigin, 'http://localhost:5173', 'http://localhost:3000'], credentials: true }));
